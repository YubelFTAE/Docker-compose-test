...
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo ROOTHOST.THIS_TEM_PATH; ?>css/jquery.contextMenu.css">

<link rel="stylesheet" type="text/css" media="screen" href="<?php echo ROOTHOST.THIS_TEM_PATH; ?>css/style_cbo.css"> 